---
name: "Library/Mr-xRed/VirtualPageDocumentExplorer"
tags: meta/library
...
> **danger** Deprecated
> The Development of the Document Explorer was moved to the Side Panel version
> This library is deprecated and therefore no longer maintained. No new features and no bug-fixes.

> **warning** Warning
> The name of the command changed from: <Navigate: Document Explorer> to <Navigate: Virtual Page Document Explorer>
...
## GoTo: ${widgets.commandButton("Document Explorer","Navigate: Virtual Page Document Explorer")} or use shortcut: `Ctrl-Alt-d`
...
function widgets.documentExplorer(folderPrefix, height, viewMode)
  ...
  local wrapperClass =
    "document-explorer-vp-wrapper " .. viewMode .. "-view"
  ...
  local html =
    ...
    breadcrumbHtml ..
    "<div class='document-explorer-vp' style='max-height:" .. height .. ";'>"
...
/* ---------- GRID VIEW ---------- */
.document-explorer-vp-wrapper.grid-view .document-explorer-vp {
  display: grid;
...
.document-explorer-vp-wrapper.grid-view .image-tile {
  flex-direction: column;
  justify-content: space-between; /* title at bottom */
  box-shadow: 0 2px 6px oklch(0 0 0 / 0.15);
}

.document-explorer-vp-wrapper.grid-view .image-title {
  text-align: center;
}

.document-explorer-vp-wrapper.grid-view .folder-icon,
.document-explorer-vp-wrapper.grid-view .md-icon,
.document-explorer-vp-wrapper.grid-view .pdf-icon,
.document-explorer-vp-wrapper.grid-view .excalidraw-icon,
.document-explorer-vp-wrapper.grid-view .drawio-icon,
.document-explorer-vp-wrapper.grid-view .unknown-icon {
  font-size: var(--icon-size-grid);
  margin-top: calc((var(--tile-size) - var(--icon-size-grid)) / 2 - 10px);
}

.document-explorer-vp-wrapper.grid-view .image-tile .image-thumb {
  width: 100%;
  height: calc(var(--tile-size) - 30px);
}

/* ---------- LIST VIEW ---------- */
.document-explorer-vp-wrapper.list-view .document-explorer-vp {
  display: flex;
  flex-direction: column;
  gap: 0; /* removed gap */
  padding: 1em;
...
.document-explorer-vp-wrapper.list-view .image-tile {
  flex-direction: row;
  border-radius: 0;
  align-items: center;
  gap: 8px;
...
.document-explorer-vp-wrapper.list-view .image-title {
  text-align: left;
  padding: 5px;
}

.document-explorer-vp-wrapper.list-view .folder-icon,
.document-explorer-vp-wrapper.list-view .md-icon,
.document-explorer-vp-wrapper.list-view .pdf-icon,
.document-explorer-vp-wrapper.list-view .excalidraw-icon,
.document-explorer-vp-wrapper.list-view .drawio-icon,
.document-explorer-vp-wrapper.list-view .unknown-icon {
...
.document-explorer-vp-wrapper.grid-view .image-thumb {
  width: 100%;
  height: calc(var(--tile-size) - 40px);
}

/* List view: square thumbnail */
.document-explorer-vp-wrapper.list-view .image-thumb {
  flex: 0 0 auto;
  width: 36px;
  height: 36px;
}
